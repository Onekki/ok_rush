...
class StarArkPage extends StatefulWidget {
  const StarArkPage({Key? key}) : super(key: key);

  @override
  State<StarArkPage> createState() => _StarArkPageState();
}

class _StarArkPageState extends AuthRequiredState<StarArkPage> {
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        DropdownButton(
                            ...
                            items: [
                              DropdownMenuItem(
                                child: Text(categoryMap[StarArkCategory.box]![
                                    CategoryProperty.name]!),
                                value: StarArkCategory.box,
                              ),
                              DropdownMenuItem(
                                child: Text(categoryMap[StarArkCategory
                                    .product]![CategoryProperty.name]!),
                            ...
                            onChanged: _isRunning
                                ? null
                                : (value) {
                                    _category = value as StarArkCategory;
                                    _fetchConfig();
                                  }),
                      ],
                    ),
